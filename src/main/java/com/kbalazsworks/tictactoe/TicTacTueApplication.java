...
import com.kbalazsworks.tictactoe.spring_config.ApplicationProperties;
...
//@EnableSwagger2
//@EnableOpenApi
public class TicTacTueApplication
{
    public static void main(String[] args)
    {
        SpringApplication.run(TicTacTueApplication.class, args);
    }
